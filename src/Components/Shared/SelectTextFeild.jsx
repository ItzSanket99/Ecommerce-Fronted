  ...
  return (
    ...
    <div className='flex flex-col gap-2 w-full' >
        ...
        <div className='relative' >
            ...
            >
                {lists.map((item) => (
                <ListboxOption key={item?.categoryId} value={item} className="group relative cursor-default py-2 pl-3 pr-9 text-gray-900 data-focus:bg-indigo-600 data-focus:text-white">
